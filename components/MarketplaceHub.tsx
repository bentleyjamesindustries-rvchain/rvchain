...
export default function MarketplaceHub({ user, displayHandle, onRequestSignIn }: Props) {
  ...
  const publishRv = () => {
    ...
    saveUserListing({
      ...
      features: [],
      image: rvForm.image.trim() || 'https://picsum.photos/id/1048/800/500',
  ...
  const publishGear = () => {
    ...
    saveUserGearListing({
      ...
      image: gearForm.image.trim() || 'https://picsum.photos/id/201/800/500',
      sellerName: displayHandle,
      sellerUserId: user.id,
      listedAt: new Date().toISOString(),
      listingAccess,
  ...
  const publishParts = () => {
    ...
    saveUserPartsListing({
      ...
      image: partsForm.image.trim() || 'https://picsum.photos/id/133/800/500',
      sellerName: displayHandle,
      sellerUserId: user.id,
      listedAt: new Date().toISOString(),
      listingAccess,
