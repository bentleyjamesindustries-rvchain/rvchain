...
export const MEMBERSHIP_PLANS: MembershipPlan[] = [
  ...
  },
  {
    id: 'weekender',
    name: 'Weekender',
    tagline: 'Plan weekend trips, post in the forum, pack smarter',
    priceMonthly: 5.99,
    priceAnnual: 59,
    trialDays: 7,
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      'Arrival tips from park listings',
      'Road Tripper forum badge',
      '+15% check-in point bonus',
    ],
    accent: 'text-sky-400',
    maxActiveTrips: 'unlimited',
    checklistPacks: 'all',
