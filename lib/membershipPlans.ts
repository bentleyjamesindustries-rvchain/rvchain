...
export const MEMBERSHIP_PLANS: MembershipPlan[] = [
  {
    ...
    trialDays: 0,
    features: [
      'Browse community spots & map (sign-in)',
      'Little Explorer games & field guide (no tracking)',
      'Browse Market listings free',
      'Upgrade for trips, forum posts & Road Crew',
    ],
