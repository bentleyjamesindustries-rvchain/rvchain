...
export const SEED_PARTS_LISTINGS: PartsListing[] = [
  {
    ...
    brand: 'Trailforge Tow',
    condition: 'good',
    price: 185,
    quantity: 1,
    city: 'Dallas',
    state: 'TX',
    description: 'Demo sample hitch set with bars. Fitment is buyer responsibility. Fictional listing.',
    image: marketplacePartsImage(0),
    sellerName: 'DemoTowSeller',
